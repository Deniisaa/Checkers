...
namespace MVP_Checkers.Services
{
    public class Utility
    {
        #region constValues
        //const image paths
        public const string purpleSquare = "C:\\Users\\Acasa\\OneDrive\\Desktop\\IlieDenisa_CheckersMVP2\\MVP_Checkers\\Resources\\purpleSquare.png";
        public const string pinkSquare = "C:\\Users\\Acasa\\OneDrive\\Desktop\\IlieDenisa_CheckersMVP2\\MVP_Checkers\\Resources\\PinkSquare.png";
        public const string RedCircle = "C:\\Users\\Acasa\\OneDrive\\Desktop\\IlieDenisa_CheckersMVP2\\MVP_Checkers\\Resources\\RedCircle.png";
        public const string WhiteCircle = "C:\\Users\\Acasa\\OneDrive\\Desktop\\IlieDenisa_CheckersMVP2\\MVP_Checkers\\Resources\\WhiteCircle.png";
        public const string HelpSquare = "C:\\Users\\Acasa\\OneDrive\\Desktop\\IlieDenisa_CheckersMVP2\\MVP_Checkers\\Resources\\HelpSquare.png";
        public const string redKing = "C:\\Users\\Acasa\\OneDrive\\Desktop\\IlieDenisa_CheckersMVP2\\MVP_Checkers\\Resources\\RedKing.png";
        public const string whiteKing = "C:\\Users\\Acasa\\OneDrive\\Desktop\\IlieDenisa_CheckersMVP2\\MVP_Checkers\\Resources\\whiteKing.png";
        ...
        public static ObservableCollection<ObservableCollection<GameSquare>> initBoard()
        {
            ...
            for (int row = 0; row < boardSize; ++row)
            {
                ...
                for (int column = 0; column < boardSize; ++column)
                {
                    if ((row + column) % 2 == 0)
                    {
                        board[row].Add(new GameSquare(row, column, SquareColor.Light, null));
                    }
                    else if (row < 3)
                    {
                        board[row].Add(new GameSquare(row, column, SquareColor.Dark, new GamePiece(PieceColor.White)));
                    }
                    else if (row > 4)
                    {
                        board[row].Add(new GameSquare(row, column, SquareColor.Dark, new GamePiece(PieceColor.Red)));
                    }
                    else
                    {
                        board[row].Add(new GameSquare(row, column, SquareColor.Dark, null));
                    }
                }
            }
        ...
        public static void LoadGame(ObservableCollection<ObservableCollection<GameSquare>> squares)
        {
            ...
            if(answer == true)
            {
                ...
                using (var reader = new StreamReader(path))
                {
                    ...
                    {
                        CurrentSquare.Texture = purpleSquare;
                    }
        ...
        public static void About()
        {
            ...
            string PATH = "C:/Users/Acasa/OneDrive/Desktop/IlieDenisa_CheckersMVP2/MVP_Checkers/Resources/about.txt";
        ...
        {
            string PATH = "C:/Users/Acasa/OneDrive/Desktop/IlieDenisa_CheckersMVP2/MVP_Checkers/Resources/winnerText.txt";
            using (var writer = new StreamWriter(PATH))
            {
